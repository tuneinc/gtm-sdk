...

{
  ...
  "description": "The TUNE tag allows you to track both clicks and conversions for your partner marketing platform with minimal configuration and great flexibility.",
  "containerContexts": [
    "WEB"
  ]
}
